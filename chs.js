...
var cnItems = {
    ...
    ": Gain the relic unique to this tier of plane. These are powerful passive boosts that can be empowered. You can only have 1 of each relic. Relics can only appear with the +relic influence, and will always be the last treasure on a plane.": "：获得该层位面独有的遗物。 这些是可以被授权的强大的被动助推器。 每个遗物你只能拥有 1 个。 遗物只能在 +relic 影响下出现，并且永远是一个位面的最后一件宝物。",
    ...
    "Caches": "缓存",
    "Coal-tier Portal": "煤炭级传送门",
    "Copper-tier Portal": "铜级传送门",
    "Diamond-tier Portal": "钻石级传送门",
    "Dirt-tier Base Cost": "灰尘级基本成本",
    "Dirt-tier Portal": "灰尘级传送门",
    "Emerald-tier Portal": "翡翠级传送门",
    "Energy Mult": "能源批量",
    "Gained": "获得",
    "Gen": "生成",
    "Gold-tier Portal": "黄金级传送门",
    "Gravel-tier Portal": "砾石级传送门",
    "Iron-tier Portal": "铁级传送门",
    ...
    "Spawn unobtainium-tier portal - 1.00e114 energy": "城市镨级传送门 - 1.00e114 能源",
    "Spawning unobtainium-tier portal": "产生镨级传送门",
    "Trash Can - Drag a portal to me!": "垃圾桶 - 拖一个传送门到这里！",
    "Types of potential treasures:": "潜在宝藏的类型：",
    "Ultimatum-tier Portal": "难得素级传送门",
    "Unobtainium-tier Base Cost": "镨级基本成本",
    "Unobtainium-tier Portal": "镨级传送门",
    "Wood-tier Portal": "木头级传送门",
    "": "",
    "": "",
    "": "",
    "": "",
