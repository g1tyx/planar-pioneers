...
var cnItems = {
    ...
    "Iuthrosie Gain": "Iuthrosie 增益",
    "Draivanope Gain": "Draivanope 增益",
    "Silver Gain": "银 增益",
    "Stone Gain": "石头 增益",
    "Satov Gain": "Satov 增益",
    ...
    "platinum": "铂",
    "ultimatum": "死亡通牒",
    "Treasure's 2 tiers stronger": "宝藏的2层更强",
    "Creating portals costs 20x less energy": "创建传送门的能源成本降低 20 倍",
    "log(energy)^0.5 boosts planes' resource gain": "log(能源)^0.5 提升镜面的资源获取",
    "Quadruple dimensions' tick rate": "四倍维度 tick 速率",
    "(Powered machines)^2 boost quarry speed": "（供能机器）^2 提高采石场速度",
    "2 free levels for repeatables": "2 可重复免费等级",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Cache: Gain (.+) your current iron \(no modifiers\).$/, '缓存：获得 $1 你当前的铁（无概览）。'],
